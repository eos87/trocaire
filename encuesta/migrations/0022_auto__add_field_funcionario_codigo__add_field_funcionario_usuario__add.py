...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Funcionario.codigo'
        db.add_column('encuesta_funcionario', 'codigo', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Funcionario.usuario'
        db.add_column('encuesta_funcionario', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)

        # Adding field 'Lider.codigo'
        db.add_column('encuesta_lider', 'codigo', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Lider.usuario'
        db.add_column('encuesta_lider', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)

        # Adding field 'Mujer.codigo'
        db.add_column('encuesta_mujer', 'codigo', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Mujer.usuario'
        db.add_column('encuesta_mujer', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)

        # Adding field 'Hombre.codigo'
        db.add_column('encuesta_hombre', 'codigo', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Hombre.usuario'
        db.add_column('encuesta_hombre', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Funcionario.codigo'
        db.delete_column('encuesta_funcionario', 'codigo')

        # Deleting field 'Funcionario.usuario'
        db.delete_column('encuesta_funcionario', 'usuario_id')

        # Deleting field 'Lider.codigo'
        db.delete_column('encuesta_lider', 'codigo')

        # Deleting field 'Lider.usuario'
        db.delete_column('encuesta_lider', 'usuario_id')

        # Deleting field 'Mujer.codigo'
        db.delete_column('encuesta_mujer', 'codigo')

        # Deleting field 'Mujer.usuario'
        db.delete_column('encuesta_mujer', 'usuario_id')

        # Deleting field 'Hombre.codigo'
        db.delete_column('encuesta_hombre', 'codigo')

        # Deleting field 'Hombre.usuario'
        db.delete_column('encuesta_hombre', 'usuario_id')
