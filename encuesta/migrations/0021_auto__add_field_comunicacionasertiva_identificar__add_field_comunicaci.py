...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ComunicacionAsertiva.identificar'
        db.add_column('encuesta_comunicacionasertiva', 'identificar', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'ComunicacionAsertiva.analizar'
        db.add_column('encuesta_comunicacionasertiva', 'analizar', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'ComunicacionAsertiva.identificar_prioridad'
        db.add_column('encuesta_comunicacionasertiva', 'identificar_prioridad', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'ComunicacionAsertiva.pido'
        db.add_column('encuesta_comunicacionasertiva', 'pido', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'ComunicacionAsertiva.actitud_pasiva'
        db.add_column('encuesta_comunicacionasertiva', 'actitud_pasiva', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ComunicacionAsertiva.identificar'
        db.delete_column('encuesta_comunicacionasertiva', 'identificar')

        # Deleting field 'ComunicacionAsertiva.analizar'
        db.delete_column('encuesta_comunicacionasertiva', 'analizar')

        # Deleting field 'ComunicacionAsertiva.identificar_prioridad'
        db.delete_column('encuesta_comunicacionasertiva', 'identificar_prioridad')

        # Deleting field 'ComunicacionAsertiva.pido'
        db.delete_column('encuesta_comunicacionasertiva', 'pido')

        # Deleting field 'ComunicacionAsertiva.actitud_pasiva'
        db.delete_column('encuesta_comunicacionasertiva', 'actitud_pasiva')
