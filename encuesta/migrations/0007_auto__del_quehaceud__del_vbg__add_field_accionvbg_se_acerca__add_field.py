...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionVBG.se_acerca'
        db.add_column('encuesta_accionvbg', 'se_acerca', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AccionVBG.invita_actividad'
        db.add_column('encuesta_accionvbg', 'invita_actividad', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AccionVBG.no_hace_nada'
        db.add_column('encuesta_accionvbg', 'no_hace_nada', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AccionVBG.no_hace_problema'
        db.add_column('encuesta_accionvbg', 'no_hace_problema', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AccionVBG.busca_alternativa'
        db.add_column('encuesta_accionvbg', 'busca_alternativa', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AccionVBG.no_sabe'
        db.add_column('encuesta_accionvbg', 'no_sabe', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AccionVBG.se_acerca'
        db.delete_column('encuesta_accionvbg', 'se_acerca')

        # Deleting field 'AccionVBG.invita_actividad'
        db.delete_column('encuesta_accionvbg', 'invita_actividad')

        # Deleting field 'AccionVBG.no_hace_nada'
        db.delete_column('encuesta_accionvbg', 'no_hace_nada')

        # Deleting field 'AccionVBG.no_hace_problema'
        db.delete_column('encuesta_accionvbg', 'no_hace_problema')

        # Deleting field 'AccionVBG.busca_alternativa'
        db.delete_column('encuesta_accionvbg', 'busca_alternativa')

        # Deleting field 'AccionVBG.no_sabe'
        db.delete_column('encuesta_accionvbg', 'no_sabe')
