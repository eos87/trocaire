...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Quien2'
        db.create_table('encuesta_quien2', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('encuesta', ['Quien2'])

        # Adding model 'PrevalenciaVBGHombre'
        db.create_table('encuesta_prevalenciavbghombre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('encuesta', ['PrevalenciaVBGHombre'])

        # Adding M2M table for field quien on 'PrevalenciaVBGHombre'
        db.create_table('encuesta_prevalenciavbghombre_quien', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prevalenciavbghombre', models.ForeignKey(orm['encuesta.prevalenciavbghombre'], null=False)),
            ('quien2', models.ForeignKey(orm['encuesta.quien2'], null=False))
        ))
        db.create_unique('encuesta_prevalenciavbghombre_quien', ['prevalenciavbghombre_id', 'quien2_id'])

        # Adding model 'Hombre'
        db.create_table('encuesta_hombre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('encuesta', ['Hombre'])

        # Changing field 'PrevalenciaVBG.que_tipo'
        db.alter_column('encuesta_prevalenciavbg', 'que_tipo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'PrevalenciaVBG.frecuencia'
        db.alter_column('encuesta_prevalenciavbg', 'frecuencia', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting model 'Quien2'
        db.delete_table('encuesta_quien2')

        # Deleting model 'PrevalenciaVBGHombre'
        db.delete_table('encuesta_prevalenciavbghombre')

        # Removing M2M table for field quien on 'PrevalenciaVBGHombre'
        db.delete_table('encuesta_prevalenciavbghombre_quien')

        # Deleting model 'Hombre'
        db.delete_table('encuesta_hombre')

        # Changing field 'PrevalenciaVBG.que_tipo'
        db.alter_column('encuesta_prevalenciavbg', 'que_tipo', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PrevalenciaVBG.frecuencia'
        db.alter_column('encuesta_prevalenciavbg', 'frecuencia', self.gf('django.db.models.fields.IntegerField')())
