...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformacionSocioEconomica.hace_dinero'
        db.alter_column('encuesta_informacionsocioeconomica', 'hace_dinero', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'InformacionSocioEconomica.hace_dinero'
        db.alter_column('encuesta_informacionsocioeconomica', 'hace_dinero', self.gf('django.db.models.fields.IntegerField')())
