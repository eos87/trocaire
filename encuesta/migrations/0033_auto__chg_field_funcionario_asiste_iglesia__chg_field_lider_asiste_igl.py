...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Funcionario.asiste_iglesia'
        db.alter_column('encuesta_funcionario', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Lider.asiste_iglesia'
        db.alter_column('encuesta_lider', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Mujer.asiste_iglesia'
        db.alter_column('encuesta_mujer', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Hombre.asiste_iglesia'
        db.alter_column('encuesta_hombre', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'PrevalenciaVBGLider.ha_vivido_vbg2'
        db.add_column('encuesta_prevalenciavbglider', 'ha_vivido_vbg2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'PrevalenciaVBGLider.frecuencia2'
        db.add_column('encuesta_prevalenciavbglider', 'frecuencia2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field que_tipo2 on 'PrevalenciaVBGLider'
        db.create_table('encuesta_prevalenciavbglider_que_tipo2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prevalenciavbglider', models.ForeignKey(orm['encuesta.prevalenciavbglider'], null=False)),
            ('tipovbg', models.ForeignKey(orm['encuesta.tipovbg'], null=False))
        ))
        db.create_unique('encuesta_prevalenciavbglider_que_tipo2', ['prevalenciavbglider_id', 'tipovbg_id'])

        # Adding M2M table for field quien2 on 'PrevalenciaVBGLider'
        db.create_table('encuesta_prevalenciavbglider_quien2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prevalenciavbglider', models.ForeignKey(orm['encuesta.prevalenciavbglider'], null=False)),
            ('quien2', models.ForeignKey(orm['encuesta.quien2'], null=False))
        ))
        db.create_unique('encuesta_prevalenciavbglider_quien2', ['prevalenciavbglider_id', 'quien2_id'])

        # Changing field 'PrevalenciaVBGLider.ha_vivido_vbg'
        db.alter_column('encuesta_prevalenciavbglider', 'ha_vivido_vbg', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True))

        # Changing field 'RutaCritica.pasos'
        db.alter_column('encuesta_rutacritica', 'pasos', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'Funcionario.asiste_iglesia'
        db.alter_column('encuesta_funcionario', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Lider.asiste_iglesia'
        db.alter_column('encuesta_lider', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Mujer.asiste_iglesia'
        db.alter_column('encuesta_mujer', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Hombre.asiste_iglesia'
        db.alter_column('encuesta_hombre', 'asiste_iglesia', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'PrevalenciaVBGLider.ha_vivido_vbg2'
        db.delete_column('encuesta_prevalenciavbglider', 'ha_vivido_vbg2')

        # Deleting field 'PrevalenciaVBGLider.frecuencia2'
        db.delete_column('encuesta_prevalenciavbglider', 'frecuencia2')

        # Removing M2M table for field que_tipo2 on 'PrevalenciaVBGLider'
        db.delete_table('encuesta_prevalenciavbglider_que_tipo2')

        # Removing M2M table for field quien2 on 'PrevalenciaVBGLider'
        db.delete_table('encuesta_prevalenciavbglider_quien2')

        # Changing field 'PrevalenciaVBGLider.ha_vivido_vbg'
        db.alter_column('encuesta_prevalenciavbglider', 'ha_vivido_vbg', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'RutaCritica.pasos'
        db.alter_column('encuesta_rutacritica', 'pasos', self.gf('django.db.models.fields.BooleanField')())
