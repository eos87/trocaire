...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Creencia.respuesta'
        db.delete_column('encuesta_creencia', 'respuesta')

        # Deleting field 'Creencia.creencia'
        db.delete_column('encuesta_creencia', 'creencia')

        # Adding field 'Creencia.esposa_obedece'
        db.add_column('encuesta_creencia', 'esposa_obedece', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Creencia.problema_familiar'
        db.add_column('encuesta_creencia', 'problema_familiar', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Creencia.quien_manda'
        db.add_column('encuesta_creencia', 'quien_manda', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Creencia.escoger_amistades'
        db.add_column('encuesta_creencia', 'escoger_amistades', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Creencia.sezo_obligacion'
        db.add_column('encuesta_creencia', 'sezo_obligacion', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Creencia.hombre_maltrata'
        db.add_column('encuesta_creencia', 'hombre_maltrata', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Creencia.respuesta'
        raise RuntimeError("Cannot reverse this migration. 'Creencia.respuesta' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Creencia.creencia'
        raise RuntimeError("Cannot reverse this migration. 'Creencia.creencia' and its values cannot be restored.")

        # Deleting field 'Creencia.esposa_obedece'
        db.delete_column('encuesta_creencia', 'esposa_obedece')

        # Deleting field 'Creencia.problema_familiar'
        db.delete_column('encuesta_creencia', 'problema_familiar')

        # Deleting field 'Creencia.quien_manda'
        db.delete_column('encuesta_creencia', 'quien_manda')

        # Deleting field 'Creencia.escoger_amistades'
        db.delete_column('encuesta_creencia', 'escoger_amistades')

        # Deleting field 'Creencia.sezo_obligacion'
        db.delete_column('encuesta_creencia', 'sezo_obligacion')

        # Deleting field 'Creencia.hombre_maltrata'
        db.delete_column('encuesta_creencia', 'hombre_maltrata')
    ...
    models = {
        ...
        'encuesta.creencia': {
            ...
            'sezo_obligacion': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        'encuesta.decision': {
