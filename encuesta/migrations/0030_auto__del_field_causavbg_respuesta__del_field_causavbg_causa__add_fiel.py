...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CausaVBG.respuesta'
        db.delete_column('encuesta_causavbg', 'respuesta')

        # Deleting field 'CausaVBG.causa'
        db.delete_column('encuesta_causavbg', 'causa')

        # Adding field 'CausaVBG.mujer_objeto'
        db.add_column('encuesta_causavbg', 'mujer_objeto', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.tipo_educacion'
        db.add_column('encuesta_causavbg', 'tipo_educacion', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.machismo'
        db.add_column('encuesta_causavbg', 'machismo', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.tiene_derecho'
        db.add_column('encuesta_causavbg', 'tiene_derecho', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.influencia_medios'
        db.add_column('encuesta_causavbg', 'influencia_medios', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.influencia_religion'
        db.add_column('encuesta_causavbg', 'influencia_religion', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.desconocimiento'
        db.add_column('encuesta_causavbg', 'desconocimiento', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'CausaVBG.cultura'
        db.add_column('encuesta_causavbg', 'cultura', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CausaVBG.respuesta'
        raise RuntimeError("Cannot reverse this migration. 'CausaVBG.respuesta' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CausaVBG.causa'
        raise RuntimeError("Cannot reverse this migration. 'CausaVBG.causa' and its values cannot be restored.")

        # Deleting field 'CausaVBG.mujer_objeto'
        db.delete_column('encuesta_causavbg', 'mujer_objeto')

        # Deleting field 'CausaVBG.tipo_educacion'
        db.delete_column('encuesta_causavbg', 'tipo_educacion')

        # Deleting field 'CausaVBG.machismo'
        db.delete_column('encuesta_causavbg', 'machismo')

        # Deleting field 'CausaVBG.tiene_derecho'
        db.delete_column('encuesta_causavbg', 'tiene_derecho')

        # Deleting field 'CausaVBG.influencia_medios'
        db.delete_column('encuesta_causavbg', 'influencia_medios')

        # Deleting field 'CausaVBG.influencia_religion'
        db.delete_column('encuesta_causavbg', 'influencia_religion')

        # Deleting field 'CausaVBG.desconocimiento'
        db.delete_column('encuesta_causavbg', 'desconocimiento')

        # Deleting field 'CausaVBG.cultura'
        db.delete_column('encuesta_causavbg', 'cultura')
