...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConceptoViolencia.respuesta'
        db.add_column('encuesta_conceptoviolencia', 'respuesta', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ConceptoViolencia.respuesta'
        db.delete_column('encuesta_conceptoviolencia', 'respuesta')
