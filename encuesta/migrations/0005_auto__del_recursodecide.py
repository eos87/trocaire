...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'RecursoDecide'
        db.delete_table('encuesta_recursodecide')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'RecursoDecide'
        db.create_table('encuesta_recursodecide', (
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('encuesta', ['RecursoDecide'])
