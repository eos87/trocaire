...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TipoVBG'
        db.create_table('encuesta_tipovbg', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('encuesta', ['TipoVBG'])

        # Deleting field 'PrevalenciaVBG.que_tipo'
        db.delete_column('encuesta_prevalenciavbg', 'que_tipo')

        # Adding M2M table for field que_tipo on 'PrevalenciaVBG'
        db.create_table('encuesta_prevalenciavbg_que_tipo', (
        ...
        db.create_unique('encuesta_prevalenciavbg_que_tipo', ['prevalenciavbg_id', 'tipovbg_id'])


    def backwards(self, orm):
        
        # Deleting model 'TipoVBG'
        db.delete_table('encuesta_tipovbg')

        # Adding field 'PrevalenciaVBG.que_tipo'
        db.add_column('encuesta_prevalenciavbg', 'que_tipo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field que_tipo on 'PrevalenciaVBG'
        db.delete_table('encuesta_prevalenciavbg_que_tipo')
