...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RecursoCuentaIns'
        db.create_table('encuesta_recursocuentains', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('encuesta', ['RecursoCuentaIns'])

        # Adding model 'Accion'
        db.create_table('encuesta_accion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('encuesta', ['Accion'])

        # Deleting field 'AccionMejorarAtencion.cuales'
        db.delete_column('encuesta_accionmejoraratencion', 'cuales')

        # Deleting field 'AccionMejorarAtencion.recursos'
        db.delete_column('encuesta_accionmejoraratencion', 'recursos')

        # Adding M2M table for field cuales on 'AccionMejorarAtencion'
        db.create_table('encuesta_accionmejoraratencion_cuales', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accionmejoraratencion', models.ForeignKey(orm['encuesta.accionmejoraratencion'], null=False)),
            ('accion', models.ForeignKey(orm['encuesta.accion'], null=False))
        ))
        db.create_unique('encuesta_accionmejoraratencion_cuales', ['accionmejoraratencion_id', 'accion_id'])

        # Adding M2M table for field recursos on 'AccionMejorarAtencion'
        db.create_table('encuesta_accionmejoraratencion_recursos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accionmejoraratencion', models.ForeignKey(orm['encuesta.accionmejoraratencion'], null=False)),
            ('recursocuentains', models.ForeignKey(orm['encuesta.recursocuentains'], null=False))
        ))
        db.create_unique('encuesta_accionmejoraratencion_recursos', ['accionmejoraratencion_id', 'recursocuentains_id'])

        # Changing field 'RegistroDato.cuantos'
        db.alter_column('encuesta_registrodato', 'cuantos', self.gf('django.db.models.fields.IntegerField')(blank=True))


    def backwards(self, orm):
        
        # Deleting model 'RecursoCuentaIns'
        db.delete_table('encuesta_recursocuentains')

        # Deleting model 'Accion'
        db.delete_table('encuesta_accion')

        # Adding field 'AccionMejorarAtencion.cuales'
        db.add_column('encuesta_accionmejoraratencion', 'cuales', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'AccionMejorarAtencion.recursos'
        db.add_column('encuesta_accionmejoraratencion', 'recursos', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Removing M2M table for field cuales on 'AccionMejorarAtencion'
        db.delete_table('encuesta_accionmejoraratencion_cuales')

        # Removing M2M table for field recursos on 'AccionMejorarAtencion'
        db.delete_table('encuesta_accionmejoraratencion_recursos')

        # Changing field 'RegistroDato.cuantos'
        db.alter_column('encuesta_registrodato', 'cuantos', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
