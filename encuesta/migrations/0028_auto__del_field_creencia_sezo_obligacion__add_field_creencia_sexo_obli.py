...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Creencia.sexo_obligacion'
        db.add_column('encuesta_creencia', 'sexo_obligacion', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Creencia.sexo_obligacion'
        db.delete_column('encuesta_creencia', 'sexo_obligacion')
