...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PrevalenciaVBGHombre.que_tipo'
        db.delete_column('encuesta_prevalenciavbghombre', 'que_tipo')

        # Adding M2M table for field que_tipo on 'PrevalenciaVBGHombre'
        db.create_table('encuesta_prevalenciavbghombre_que_tipo', (
        ...
        db.create_unique('encuesta_prevalenciavbghombre_que_tipo', ['prevalenciavbghombre_id', 'tipovbg_id'])

        # Deleting field 'PrevalenciaVBGLider.que_tipo'
        db.delete_column('encuesta_prevalenciavbglider', 'que_tipo')

        # Adding M2M table for field que_tipo on 'PrevalenciaVBGLider'
        db.create_table('encuesta_prevalenciavbglider_que_tipo', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prevalenciavbglider', models.ForeignKey(orm['encuesta.prevalenciavbglider'], null=False)),
            ('tipovbg', models.ForeignKey(orm['encuesta.tipovbg'], null=False))
        ))
        db.create_unique('encuesta_prevalenciavbglider_que_tipo', ['prevalenciavbglider_id', 'tipovbg_id'])


    def backwards(self, orm):
        
        # Adding field 'PrevalenciaVBGHombre.que_tipo'
        db.add_column('encuesta_prevalenciavbghombre', 'que_tipo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field que_tipo on 'PrevalenciaVBGHombre'
        db.delete_table('encuesta_prevalenciavbghombre_que_tipo')

        # Adding field 'PrevalenciaVBGLider.que_tipo'
        db.add_column('encuesta_prevalenciavbglider', 'que_tipo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field que_tipo on 'PrevalenciaVBGLider'
        db.delete_table('encuesta_prevalenciavbglider_que_tipo')
