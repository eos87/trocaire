...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contraparte.pais'
        db.add_column('encuesta_contraparte', 'pais', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lugar.Pais']), keep_default=False)

        # Adding field 'Contraparte.departamento'
        db.add_column('encuesta_contraparte', 'departamento', self.gf('django.db.models.fields.related.ForeignKey')(default=99, to=orm['lugar.Departamento']), keep_default=False)

        # Adding field 'Contraparte.municipio'
        db.add_column('encuesta_contraparte', 'municipio', self.gf('django.db.models.fields.related.ForeignKey')(default=5020, to=orm['lugar.Municipio']), keep_default=False)

        # Adding field 'Contraparte.logo'
        db.add_column('encuesta_contraparte', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contraparte.pais'
        db.delete_column('encuesta_contraparte', 'pais_id')

        # Deleting field 'Contraparte.departamento'
        db.delete_column('encuesta_contraparte', 'departamento_id')

        # Deleting field 'Contraparte.municipio'
        db.delete_column('encuesta_contraparte', 'municipio_id')

        # Deleting field 'Contraparte.logo'
        db.delete_column('encuesta_contraparte', 'logo')
