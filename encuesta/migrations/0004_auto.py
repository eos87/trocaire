...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field recurso on 'AccesoControlRecurso'
        db.delete_table('encuesta_accesocontrolrecurso_recurso')

        # Adding M2M table for field tumadre on 'AccesoControlRecurso'
        db.create_table('encuesta_accesocontrolrecurso_tumadre', (
        ...
        db.create_unique('encuesta_accesocontrolrecurso_tumadre', ['accesocontrolrecurso_id', 'recurso_id'])


    def backwards(self, orm):
        
        # Adding M2M table for field recurso on 'AccesoControlRecurso'
        db.create_table('encuesta_accesocontrolrecurso_recurso', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accesocontrolrecurso', models.ForeignKey(orm['encuesta.accesocontrolrecurso'], null=False)),
            ('recurso', models.ForeignKey(orm['encuesta.recurso'], null=False))
        ))
        db.create_unique('encuesta_accesocontrolrecurso_recurso', ['accesocontrolrecurso_id', 'recurso_id'])

        # Removing M2M table for field tumadre on 'AccesoControlRecurso'
        db.delete_table('encuesta_accesocontrolrecurso_tumadre')
    ...
    models = {
        ...
        'encuesta.accesocontrolrecurso': {
            ...
            'recursos_decide': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['encuesta.RecursoDecide']", 'symmetrical': 'False'}),
            'tumadre': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['encuesta.Recurso']", 'symmetrical': 'False'})
        },
        ...
        'encuesta.recursodecide': {
            'Meta': {'object_name': 'RecursoDecide'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
