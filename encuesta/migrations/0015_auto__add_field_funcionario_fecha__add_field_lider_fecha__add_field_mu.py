...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Funcionario.fecha'
        db.add_column('encuesta_funcionario', 'fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 2, 4, 16, 58, 9, 107380)), keep_default=False)

        # Adding field 'Lider.fecha'
        db.add_column('encuesta_lider', 'fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 2, 4, 16, 58, 19, 491364)), keep_default=False)

        # Adding field 'Mujer.fecha'
        db.add_column('encuesta_mujer', 'fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 2, 4, 16, 58, 26, 987368)), keep_default=False)

        # Adding field 'Hombre.fecha'
        db.add_column('encuesta_hombre', 'fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 2, 4, 16, 58, 33, 523862)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Funcionario.fecha'
        db.delete_column('encuesta_funcionario', 'fecha')

        # Deleting field 'Lider.fecha'
        db.delete_column('encuesta_lider', 'fecha')

        # Deleting field 'Mujer.fecha'
        db.delete_column('encuesta_mujer', 'fecha')

        # Deleting field 'Hombre.fecha'
        db.delete_column('encuesta_hombre', 'fecha')
