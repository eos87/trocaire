...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExpresionVBG.respuesta'
        db.delete_column('encuesta_expresionvbg', 'respuesta')

        # Deleting field 'ExpresionVBG.maneras'
        db.delete_column('encuesta_expresionvbg', 'maneras')

        # Adding field 'ExpresionVBG.golpe_mujeres'
        db.add_column('encuesta_expresionvbg', 'golpe_mujeres', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.palabras_miradas'
        db.add_column('encuesta_expresionvbg', 'palabras_miradas', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.amenaza_chantajes'
        db.add_column('encuesta_expresionvbg', 'amenaza_chantajes', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.pedir_permiso'
        db.add_column('encuesta_expresionvbg', 'pedir_permiso', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.estudio_varon'
        db.add_column('encuesta_expresionvbg', 'estudio_varon', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.obedecer_marido'
        db.add_column('encuesta_expresionvbg', 'obedecer_marido', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.sexo_obligada'
        db.add_column('encuesta_expresionvbg', 'sexo_obligada', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.progreso_hombre'
        db.add_column('encuesta_expresionvbg', 'progreso_hombre', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.marido_no_valora'
        db.add_column('encuesta_expresionvbg', 'marido_no_valora', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.hombre_celoso'
        db.add_column('encuesta_expresionvbg', 'hombre_celoso', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.marido_empuja'
        db.add_column('encuesta_expresionvbg', 'marido_empuja', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.sexo_sin_proteccion'
        db.add_column('encuesta_expresionvbg', 'sexo_sin_proteccion', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.pedir_dinero'
        db.add_column('encuesta_expresionvbg', 'pedir_dinero', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.propiedades_hombre'
        db.add_column('encuesta_expresionvbg', 'propiedades_hombre', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.mujer_divertirse'
        db.add_column('encuesta_expresionvbg', 'mujer_divertirse', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.mujer_participe'
        db.add_column('encuesta_expresionvbg', 'mujer_participe', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'ExpresionVBG.no_organizarte'
        db.add_column('encuesta_expresionvbg', 'no_organizarte', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ExpresionVBG.respuesta'
        raise RuntimeError("Cannot reverse this migration. 'ExpresionVBG.respuesta' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ExpresionVBG.maneras'
        raise RuntimeError("Cannot reverse this migration. 'ExpresionVBG.maneras' and its values cannot be restored.")

        # Deleting field 'ExpresionVBG.golpe_mujeres'
        db.delete_column('encuesta_expresionvbg', 'golpe_mujeres')

        # Deleting field 'ExpresionVBG.palabras_miradas'
        db.delete_column('encuesta_expresionvbg', 'palabras_miradas')

        # Deleting field 'ExpresionVBG.amenaza_chantajes'
        db.delete_column('encuesta_expresionvbg', 'amenaza_chantajes')

        # Deleting field 'ExpresionVBG.pedir_permiso'
        db.delete_column('encuesta_expresionvbg', 'pedir_permiso')

        # Deleting field 'ExpresionVBG.estudio_varon'
        db.delete_column('encuesta_expresionvbg', 'estudio_varon')

        # Deleting field 'ExpresionVBG.obedecer_marido'
        db.delete_column('encuesta_expresionvbg', 'obedecer_marido')

        # Deleting field 'ExpresionVBG.sexo_obligada'
        db.delete_column('encuesta_expresionvbg', 'sexo_obligada')

        # Deleting field 'ExpresionVBG.progreso_hombre'
        db.delete_column('encuesta_expresionvbg', 'progreso_hombre')

        # Deleting field 'ExpresionVBG.marido_no_valora'
        db.delete_column('encuesta_expresionvbg', 'marido_no_valora')

        # Deleting field 'ExpresionVBG.hombre_celoso'
        db.delete_column('encuesta_expresionvbg', 'hombre_celoso')

        # Deleting field 'ExpresionVBG.marido_empuja'
        db.delete_column('encuesta_expresionvbg', 'marido_empuja')

        # Deleting field 'ExpresionVBG.sexo_sin_proteccion'
        db.delete_column('encuesta_expresionvbg', 'sexo_sin_proteccion')

        # Deleting field 'ExpresionVBG.pedir_dinero'
        db.delete_column('encuesta_expresionvbg', 'pedir_dinero')

        # Deleting field 'ExpresionVBG.propiedades_hombre'
        db.delete_column('encuesta_expresionvbg', 'propiedades_hombre')

        # Deleting field 'ExpresionVBG.mujer_divertirse'
        db.delete_column('encuesta_expresionvbg', 'mujer_divertirse')

        # Deleting field 'ExpresionVBG.mujer_participe'
        db.delete_column('encuesta_expresionvbg', 'mujer_participe')

        # Deleting field 'ExpresionVBG.no_organizarte'
        db.delete_column('encuesta_expresionvbg', 'no_organizarte')
