...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JustificacionVBG.respuesta'
        db.delete_column('encuesta_justificacionvbg', 'respuesta')

        # Deleting field 'JustificacionVBG.justificacion'
        db.delete_column('encuesta_justificacionvbg', 'justificacion')

        # Adding field 'JustificacionVBG.licor'
        db.add_column('encuesta_justificacionvbg', 'licor', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.drogas'
        db.add_column('encuesta_justificacionvbg', 'drogas', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.estres'
        db.add_column('encuesta_justificacionvbg', 'estres', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.pobreza'
        db.add_column('encuesta_justificacionvbg', 'pobreza', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.victima'
        db.add_column('encuesta_justificacionvbg', 'victima', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.nace_asi'
        db.add_column('encuesta_justificacionvbg', 'nace_asi', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.mujer_no_caso'
        db.add_column('encuesta_justificacionvbg', 'mujer_no_caso', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.nivel_educativo'
        db.add_column('encuesta_justificacionvbg', 'nivel_educativo', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.influencia_familiar'
        db.add_column('encuesta_justificacionvbg', 'influencia_familiar', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.creencias'
        db.add_column('encuesta_justificacionvbg', 'creencias', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.comportamiento'
        db.add_column('encuesta_justificacionvbg', 'comportamiento', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'JustificacionVBG.otros'
        db.add_column('encuesta_justificacionvbg', 'otros', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'JustificacionVBG.respuesta'
        raise RuntimeError("Cannot reverse this migration. 'JustificacionVBG.respuesta' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'JustificacionVBG.justificacion'
        raise RuntimeError("Cannot reverse this migration. 'JustificacionVBG.justificacion' and its values cannot be restored.")

        # Deleting field 'JustificacionVBG.licor'
        db.delete_column('encuesta_justificacionvbg', 'licor')

        # Deleting field 'JustificacionVBG.drogas'
        db.delete_column('encuesta_justificacionvbg', 'drogas')

        # Deleting field 'JustificacionVBG.estres'
        db.delete_column('encuesta_justificacionvbg', 'estres')

        # Deleting field 'JustificacionVBG.pobreza'
        db.delete_column('encuesta_justificacionvbg', 'pobreza')

        # Deleting field 'JustificacionVBG.victima'
        db.delete_column('encuesta_justificacionvbg', 'victima')

        # Deleting field 'JustificacionVBG.nace_asi'
        db.delete_column('encuesta_justificacionvbg', 'nace_asi')

        # Deleting field 'JustificacionVBG.mujer_no_caso'
        db.delete_column('encuesta_justificacionvbg', 'mujer_no_caso')

        # Deleting field 'JustificacionVBG.nivel_educativo'
        db.delete_column('encuesta_justificacionvbg', 'nivel_educativo')

        # Deleting field 'JustificacionVBG.influencia_familiar'
        db.delete_column('encuesta_justificacionvbg', 'influencia_familiar')

        # Deleting field 'JustificacionVBG.creencias'
        db.delete_column('encuesta_justificacionvbg', 'creencias')

        # Deleting field 'JustificacionVBG.comportamiento'
        db.delete_column('encuesta_justificacionvbg', 'comportamiento')

        # Deleting field 'JustificacionVBG.otros'
        db.delete_column('encuesta_justificacionvbg', 'otros')
