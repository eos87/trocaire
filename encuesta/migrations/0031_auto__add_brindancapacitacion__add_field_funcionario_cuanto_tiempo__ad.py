...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BrindanCapacitacion'
        db.create_table('encuesta_brindancapacitacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('encuesta', ['BrindanCapacitacion'])

        # Adding field 'Funcionario.cuanto_tiempo'
        db.add_column('encuesta_funcionario', 'cuanto_tiempo', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Lider.cuanto_tiempo'
        db.add_column('encuesta_lider', 'cuanto_tiempo', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Mujer.cuanto_tiempo'
        db.add_column('encuesta_mujer', 'cuanto_tiempo', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Hombre.cuanto_tiempo'
        db.add_column('encuesta_hombre', 'cuanto_tiempo', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'AccesoInformacion.quien_brinda'
        db.delete_column('encuesta_accesoinformacion', 'quien_brinda')

        # Adding M2M table for field quien_brinda on 'AccesoInformacion'
        db.create_table('encuesta_accesoinformacion_quien_brinda', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accesoinformacion', models.ForeignKey(orm['encuesta.accesoinformacion'], null=False)),
            ('brindancapacitacion', models.ForeignKey(orm['encuesta.brindancapacitacion'], null=False))
        ))
        db.create_unique('encuesta_accesoinformacion_quien_brinda', ['accesoinformacion_id', 'brindancapacitacion_id'])


    def backwards(self, orm):
        
        # Deleting model 'BrindanCapacitacion'
        db.delete_table('encuesta_brindancapacitacion')

        # Deleting field 'Funcionario.cuanto_tiempo'
        db.delete_column('encuesta_funcionario', 'cuanto_tiempo')

        # Deleting field 'Lider.cuanto_tiempo'
        db.delete_column('encuesta_lider', 'cuanto_tiempo')

        # Deleting field 'Mujer.cuanto_tiempo'
        db.delete_column('encuesta_mujer', 'cuanto_tiempo')

        # Deleting field 'Hombre.cuanto_tiempo'
        db.delete_column('encuesta_hombre', 'cuanto_tiempo')

        # Adding field 'AccesoInformacion.quien_brinda'
        db.add_column('encuesta_accesoinformacion', 'quien_brinda', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field quien_brinda on 'AccesoInformacion'
        db.delete_table('encuesta_accesoinformacion_quien_brinda')
