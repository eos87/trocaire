...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HablanDe'
        db.create_table('encuesta_hablande', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('encuesta', ['HablanDe'])

        # Deleting field 'ConceptoViolencia.sobre'
        db.delete_column('encuesta_conceptoviolencia', 'sobre')

        # Adding field 'ConceptoViolencia.hablande'
        db.add_column('encuesta_conceptoviolencia', 'hablande', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuesta.HablanDe'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'HablanDe'
        db.delete_table('encuesta_hablande')

        # Adding field 'ConceptoViolencia.sobre'
        db.add_column('encuesta_conceptoviolencia', 'sobre', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'ConceptoViolencia.hablande'
        db.delete_column('encuesta_conceptoviolencia', 'hablande_id')
