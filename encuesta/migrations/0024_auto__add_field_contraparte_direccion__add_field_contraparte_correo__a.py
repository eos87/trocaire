...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contraparte.direccion'
        db.add_column('encuesta_contraparte', 'direccion', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Contraparte.correo'
        db.add_column('encuesta_contraparte', 'correo', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Adding field 'Contraparte.website'
        db.add_column('encuesta_contraparte', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Contraparte.telefono'
        db.add_column('encuesta_contraparte', 'telefono', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Contraparte.contacto'
        db.add_column('encuesta_contraparte', 'contacto', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Contraparte.usuario'
        db.add_column('encuesta_contraparte', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contraparte.direccion'
        db.delete_column('encuesta_contraparte', 'direccion')

        # Deleting field 'Contraparte.correo'
        db.delete_column('encuesta_contraparte', 'correo')

        # Deleting field 'Contraparte.website'
        db.delete_column('encuesta_contraparte', 'website')

        # Deleting field 'Contraparte.telefono'
        db.delete_column('encuesta_contraparte', 'telefono')

        # Deleting field 'Contraparte.contacto'
        db.delete_column('encuesta_contraparte', 'contacto')

        # Deleting field 'Contraparte.usuario'
        db.delete_column('encuesta_contraparte', 'usuario_id')
